...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস সাগর আপনি কোন মেয়েকে চুদতে চাউ সে মেয়েকে @ম্যানশন দেউ", event.threadID);
...
setTimeout(() => {a({body: "Hi সাগর এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi সাগর এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
